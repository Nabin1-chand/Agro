...
class _FishScreenState extends State<FishScreen> {
  ...
  final List<Map<String, dynamic>> fruitList = [
    {
      'name': 'Fresh Fish',
      'image': ImageConstant.singleFish,
      'price': 21.0,
    },
    {
      'name': 'Fish fry',
      'image': ImageConstant.fishOne,
      'price': 3.0,
    },
    {
      'name': 'Cat Fish',
      'image': ImageConstant.grilledFish,
      'price': 9.0,
    },
    {
      'name': 'Grilled Fish',
                    ...
                    child: ListView.separated(
                        ...
                        itemBuilder: (context, index) {
                          return AgroCollectionWidget(
                            name: filteredFishList[index]['name']!,
                            image: filteredFishList[index]['image'],
                            price: filteredFishList[index]['price']!,
                          );
                        },
